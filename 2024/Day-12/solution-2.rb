    ...
    region[1].each do |cur_pos|
      ...
      directions.each do |dir|
        ...
        if has_border && dir == [-1, 0]
          ...
          if region[1].include?(left_cell) && calc_border?(left_cell, [left_cell[0] + dir[0], left_cell[1] + dir[1]],
                                                           grid)
        ...
        if has_border && dir == [0, -1]
          ...
          if region[1].include?(top_cell) && calc_border?(top_cell, [top_cell[0] + dir[0], top_cell[1] + dir[1]],
                                                          grid)

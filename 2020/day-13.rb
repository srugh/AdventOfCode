...
earliest = 1002576
buses = [13,"x","x","x","x","x","x",37,"x","x","x","x","x",449,"x",29,"x","x","x","x","x","x","x","x","x","x","x","x","x","x","x","x",19,"x","x","x",23,"x","x","x","x","x","x","x",773,"x","x","x","x","x","x","x","x","x",41,"x","x","x","x","x","x",17]
earliest = 939
#buses = [7,13,"x","x",59,"x",31,19]

#part_1 = solve_part_1(earliest, buses)
#puts "part_1: #{part_1}"

part_2 = solve_part_2(buses)
puts "part_2: #{part_2}"
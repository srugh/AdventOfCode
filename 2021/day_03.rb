...
def solve_part2(input)
  ...
  input[0].size.times do |i|
    ...
    most = if temp_o2.size >= o2.size - temp_o2.size
             '1'
           else
             '0'
           end
    least = if temp_co2.size < co2.size - temp_co2.size
              '1'
            else
              '0'
            end
    ...
    co2 = co2.select { |b| b[i] == least } if co2.size > 1
  end
